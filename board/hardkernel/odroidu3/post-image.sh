...
# The bl1.HardKernel file provided by the uboot hardkernel repository is overwritten
# by the bl2.HardKernel in the sd_fusing.sh script because it is too big.
...
truncate -s 15360 ${BINARIES_DIR}/bl1.HardKernel
